...
map("n", "<C-k>", "<C-w>k", opt)
-- 左右比例控制
map("n", "<C-m>l", ":vertical resize -5<CR>", opt)
map("n", "<C-m>h", ":vertical resize +5<CR>", opt)
-- 上下比例  m>
map("n", "<C-m>k", ":resize +5<CR>", opt)
map("n", "<C-m>j", ":resize -5<CR>", opt)
-- 等比例
map("n", "<M-w>e", "<C-w>=", opt)
--==========window==========--
...
map("n", "<leader>I", "<cmd>LspInfo<CR>", opt)
...
map("n", "gr", "<cmd>Lspsaga outline<CR>", opt)
map("n", "gf", "<cmd>Lspsaga outgoing_calls<CR>", opt)
